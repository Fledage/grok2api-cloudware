...
> [!IMPORTANT]
> 本仓库为 Fledage 维护的 Cloudflare Workers 适配版本。原项目与原作者为 [chenyme/grok2api](https://github.com/chenyme/grok2api)，本版本在保留原有管理后台与页面体验的基础上，将最新 Grok2API 的模型目录、上游请求协议、Statsig 风控适配、Cookie/User-Agent 配置等功能同步到 Cloudflare Workers 部署层。
