...
const LOCALE_MAP = {
  ...
  "grok": {
    ...
    "imagine_public_image_proxy": { title: "公共图片代理", desc: "默认关闭时 imagine-public 图片直返上游公开链接；开启后会转为本 Worker 的 /images 代理链接。" },
    ...
    "cf_cookies": { title: "完整 CF Cookies", desc: "浏览器通过 Grok 验证后得到的完整 Cookie 字符串；会自动合并 sso/sso-rw。" },
    "user_agent": { title: "User-Agent", desc: "请求头 User-Agent，需与获取 CF Cookies 时使用的浏览器一致。" },
